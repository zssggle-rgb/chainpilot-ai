...
def scenario_from_strategy(strategy: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "max_review_actions": params["max_review_actions"],
        "max_supplier_confirmations": params["max_supplier_confirmations"],
        "approval_cash_capacity": params["approval_cash_capacity"],
        "optimization_horizon_days": params["optimization_horizon_days"],
...
def _preset(
    ...
    return {
        ...
        "parameter_json": {
            ...
            "max_review_actions": max(8, int(max_selected_actions * 0.7)),
            "max_supplier_confirmations": 4 if strategy_type == "Conservative" else 6 if strategy_type == "Recommended" else 8,
            "approval_cash_capacity": 35_000_000 if strategy_type == "Conservative" else 55_000_000 if strategy_type == "Recommended" else 75_000_000,
            "optimization_horizon_days": 45,
